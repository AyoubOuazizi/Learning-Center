    ...
    return (
      <div className="container-fluid py-3 px-4 text-white" style={{color: "#DDD", "backgroundRepeat": "no-repeat","backgroundPosition": "center","backgroundImage":"linear-gradient(180deg, rgba(28, 30, 39, 0.85), rgba(28, 30, 39, 0.85), rgba(28, 30, 39, 0.85)),\n    url('https://s3-alpha-sig.figma.com/img/0fac/874a/827500bb706df11debc9b87dd309c053?Expires=1690761600&Signature=btIqGmZH768VA2wCqkdweTSxzjiRhDs7-dt0~uotVcGn514PsC~aIFlEwiXBQYdbZII36vXAc41dK~n3-lMtbZ8KgOLXRPwnobRPypWgOvh~aYT-jbXqsaMYZpsy5urq4n5MVZAp-hjZVjIyi0o7WweGDfMjFb5-vdol5iKgnf8XUBUqeajXAdNdI~PgMlo6mZJTv1DPOx2fl2idLeo4yYXWZIsNe4uZ6BVRIO~9kpMNggINaTxhKtbTNnhwuM9jmI~mwZ-VUXHv5MJD9ZUnayNAlAn8E2yKePw13ofvKaG95bXIS28TQYGW~P5hdUgG2ECQ4J88f6PqoSNxUM~nqA__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4')", backgroundSize: "cover","flexDirection":"column","justifyContent":"flex-end","alignItems":"center", "fontSize":"15px"}}>
          <div className="row justify-content-center align-items-start g-2">
                ...
                <div className="col-2 text-start pt-3">
                    <h6 className="pb-1 mb-4" style={{borderBottom: "2px solid #E95D40", width: "fit-content"}}>Pages</h6>
                    <p className="d-flex align-items-start justify-content-start"><Link href="/about" style={{fontSize: 13, color: "rgba(255, 255, 255, 0.70)", textDecoration: "none"}}>À propos</Link></p>
                    <p className="d-flex align-items-start justify-content-start"><Link href="/about" style={{fontSize: 13, color: "rgba(255, 255, 255, 0.70)", textDecoration: "none"}}>Nos Bibliothèques</Link></p>
                    <p className="d-flex align-items-start justify-content-start"><Link href="/search" style={{fontSize: 13, color: "rgba(255, 255, 255, 0.70)", textDecoration: "none"}}>Recherche</Link></p>
                    <p className="d-flex align-items-start justify-content-start"><Link href="/#nouveautes" style={{fontSize: 13, color: "rgba(255, 255, 255, 0.70)", textDecoration: "none"}}>Nouveautés</Link></p>
                </div>
                <div className="col-2 text-start pt-3">
                    <h6 className="pb-1 mb-4" style={{borderBottom: "2px solid #E95D40", width: "fit-content"}}>Service</h6>
                ...
                <div className="col-2 text-start pt-3">
                    <h6 className="pb-1 mb-4" style={{borderBottom: "2px solid #E95D40", width: "fit-content"}}>Contact</h6>
                    <div className="d-flex align-items-start justify-content-start"><img className='pb-1 me-2' src="/images/phone2.svg" style={{"width": 18}}></img><p style={{fontSize: 13, color: "rgba(255, 255, 255, 0.70)"}}>0-524 - 32 - 11 - 00</p></div>
                    <div className="d-flex align-items-start justify-content-start"><img className='pb-1 me-2' src="/images/mail2.svg" style={{"width": 18}}></img><p style={{fontSize: 13, color: "rgba(255, 255, 255, 0.70)"}}>Info@lm6e.Ma</p></div>
                    <div className="d-flex align-items-start justify-content-start"><img className='pb-1 ms-1 me-2' src="/images/position2.svg" style={{"width": 12}}></img><p style={{fontSize: 13, color: "rgba(255, 255, 255, 0.70)"}}>Ville verte mohammed VI 42150 benguerir maroc</p></div>
                </div>
                <div className="col-3 text-start pt-3">
                    <h6 className="pb-1 mb-4" style={{borderBottom: "2px solid #E95D40", width: "fit-content"}}>Horaires d’ouverture</h6>
