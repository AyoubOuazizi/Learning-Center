...
L’équipe chargée de sa gestion dispensent à tous les élèves un parcours de formation à la culture de l’information. Elle est à la disposition des usagers pour les former à la recherche documentaire et les aider à exploiter pleinement les ressources du CDI.                </p>
                <p className='mini-tiret' style={{width: "max-content","marginLeft":"-2.1rem","color":"#2B2F37", "fontWeight":"bold"}}>Règlement du centre de documentation et d’information.  <a href="#" style={{color: "#E95D40", textDecoration: "none"}}>attacher pièce jointe <img src="/images/download.svg" className="img-fluid"></img></a></p>
                <p className='mini-tiret' style={{width: "max-content","marginLeft":"-2.1rem","color":"#2B2F37", "fontWeight":"bold"}}>Guide d’utilisation du catalogue en ligne. <a href="#" style={{color: "#E95D40", textDecoration: "none"}}>attacher pièce jointe <img src="/images/download.svg" className="img-fluid"></img></a></p>
